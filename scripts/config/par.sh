...
scripts_orchestration="$scripts/orchestration"
scripts_data="$scripts/data"
scripts_data_perl="$scripts_data/perl"
scripts_install="$scripts/install"
scripts_install_dependencies="$scripts_install/dependencies"
scripts_install_methods="$scripts_install/methods"
scripts_runtime="$scripts/runtime"
scripts_results="$scripts/results"
dataset="dataset"
redun="Redundancy"
progs="progs"
result="results"
...
#   URLs
#-------------------------------------------------------------------------------
HUMAN_FA_URL="ftp://ftp.ncbi.nlm.nih.gov/genomes/H_sapiens/Assembled_chromosomes/seq"
...
HUMAN_SAM_URL="ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/phase3/data/HG00096/alignment"
NEANDERTHAL_SAM_URL="http://cdna.eva.mpg.de/neandertal/altai/AltaiNeandertal/bam"
HUMAN_BAM_URL="ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/phase3/data/HG00096/alignment"
...
HS_SEQ_RUN=$(seq -s' ' 1 22)
HS_SEQ_RUN+=" X Y MT AL UL UP"
